...
const About = () => {
  return (
    <div id="about" className="relative bg-gray-100 top-0 lg:top-[-15px] dark:bg-gray-900">
    <section  className="bg-gray-100 p-6  sm:p-10 md:p-16 lg:p-10 text-left w-[90%] sm:w-[80%] md:w-[80%] 
    lg:w-[80%] xl:w-[58%]  mx-auto mt-[35rem] xl:mt-[40rem]  xl:ml-40 rounded-lg dark:bg-gray-900 ">
    ...
    <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 mb-4 sm:mb-6 leading-relaxed dark:text-gray-200 font-raleway">
